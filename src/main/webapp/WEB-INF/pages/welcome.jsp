               ...
               <div class="layout_wrapper">
                     ...
                     <div class="navbar navbar--header">
                        <div class="navbar_container">
                           <div class="navbar_header">
                              <a class="navbar_brand" href="/user/update">
                  ...
                  <div class="layout_content">
                     <div class="feed">
                        <div class="feed_header">
                           <h1 class="feed_title">Hello ${NAME} Welcome! </h1>
                        </div>
                        <div class="feed_item">
                           <div class="joke">
                  ...
                  <div class="layout_footer">
                     <div class="section section--search">
                        <form class="form form--search-form"><input placeholder="Search Related Codes..."></form>
                     </div>
                     <div class="section">
                        ...
                        <div class="section_block section_block--content">
                           <ul class="nav">
                              <li class="nav_item"><a class="nav_link" href="#/search/code/1"><span class="nav_link_text nav_link_text--primary">#Spring</span><span class="nav_link_text nav_link_text--secondary">Java Backend</span></a></li>
                              <li class="nav_item"><a class="nav_link" href="#/search/Walk/1"><span class="nav_link_text nav_link_text--primary">#Java</span><span class="nav_link_text nav_link_text--secondary">Language</span></a></li>
                              <li class="nav_item"><a class="nav_link" href="#/search/What/1"><span class="nav_link_text nav_link_text--primary">#SQL</span><span class="nav_link_text nav_link_text--secondary">Database</span></a></li>
                           </ul>
                        </div>
                     </div>
                     <div class="section">
                     ...
                     <div class="section">
                        <div class="section_block section_block--content">EXPLORE | HELP OTHER'S | CODE</div>
                     </div>
                  </div>
               </div>
            </div>
