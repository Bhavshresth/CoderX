    ...
    <div class="container">
        ...
        <div class="login">
            ...
            <form action="">
                ...
                <div class="input-box">
                    <input id="signup-password" type="password" placeholde r="Password">
                ...
                success: function(response){
                    ...
                    if(!!response){
                         ...
                         location.href="/user/welcome";
                          ...
                          $("#signup-password").val("");//Used to blank space the value of password
                          $("#signup-error").html("Wrong Entry");
                          $("#signup-error").show();
                         }
                    }
